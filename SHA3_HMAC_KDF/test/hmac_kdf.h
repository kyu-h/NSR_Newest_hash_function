 ...
 *
 */
void kdf_sha3_hmac(const unsigned int alg_type, const unsigned int rate, const unsigned int capacity, const unsigned char delimitedSuffix, BitSequence *Kl, unsigned int Kl_len, BitSequence *Lable, const unsigned int Label_len, BitSequence *Context, unsigned int Context_len, BitSequence *L, BitSequence *h, const unsigned int r, FILE *outf);
